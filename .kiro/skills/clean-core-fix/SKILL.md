...
- **Tune parallelism**: lower `--parallel` if SAP rate-limits or sessions thrash; raise on idle systems with high churn. Default 3 is safe across the SAP releases this has been exercised on.
